    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('features', models.TextField(blank=True, help_text='Separate features by new lines (Optional)', null=True)),
                ('care_instructions', models.TextField(blank=True, help_text='Separate instructions by new lines (Optional)', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(blank=True, null=True, upload_to='videos/products/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_override', models.DecimalField(decimal_places=2, default=0.0, help_text='Extra amount to add to base prices (e.g., 200 for L size)', max_digits=10)),
